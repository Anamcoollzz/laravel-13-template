...
class AuthController extends StislaController
{
    ...
    public function verify(Request $request)
    {
        ...
        if ($user === null) {
            abort(404);
        } elseif ($user->verification_code !== $request->verification_code) {
            return response422([
    ...
    public function checkCode(Request $request)
    {
        ...
        if ($user === null) {
            abort(404);
        } elseif ($user->verification_code !== $request->verification_code || $user->email_token === null) {
            return response422([
                'verification_code' => [__('Kode verifikasi yang dimasukkan salah.')],
            ]);
        }
    ...
    public function resetPassword(ResetPasswordRequest $request)
    {
        ...
        try {
            ...
            } elseif ($user->email_token !== $request->verification_token) {
                return response422([
