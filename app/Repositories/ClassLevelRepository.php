...
class ClassLevelRepository extends Repository
{
    ...
    public function getYajraDataTables($additionalParams = null)
    {
        ...
        $editColumns = [
            ...
            'barcode' => fn (ClassLevel $item) => DNS1DFacade::getBarcodeHTML($item->barcode, 'C39', 1, 10),
            'qr_code' => fn (ClassLevel $item) => DNS2DFacade::getBarcodeHTML($item->qr_code, 'QRCODE', 3, 3),
