...
class FacultyLeaderRepository extends Repository
{
    ...
    public function getYajraDataTables($additionalParams = null)
    {
        ...
        $editColumns = [
            ...
            'barcode' => fn (FacultyLeader $item) => DNS1DFacade::getBarcodeHTML($item->barcode, 'C39', 1, 10),
            'qr_code' => fn (FacultyLeader $item) => DNS2DFacade::getBarcodeHTML($item->qr_code, 'QRCODE', 3, 3),
