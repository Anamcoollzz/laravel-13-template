...
class SchoolYearRepository extends Repository
{
    ...
    public function getYajraDataTables($additionalParams = null)
    {
        ...
        $editColumns = [
            ...
            'barcode' => fn (SchoolYear $item) => DNS1DFacade::getBarcodeHTML($item->barcode, 'C39', 1, 10),
            'qr_code' => fn (SchoolYear $item) => DNS2DFacade::getBarcodeHTML($item->qr_code, 'QRCODE', 3, 3),
